...
<div class="container" id="ext_div" >
    <div class="row justify-content-center" id="int_div">
        <div class="col-md-8">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="mobile" class="col-md-4 col-form-label text-md-right text-light">{{ __('mobile') }}</label>
                         ...
                         <div class="form-group row">
                            <label for="aadhar" class="col-md-4 col-form-label text-md-right text-light">{{ __('aadhar') }}</label>

                            <div class="col-md-6">
                                <input id="aadhar" type="aadhar" class="form-control @error('aadhar') is-invalid @enderror" name="aadhar" value="{{ old('aadhar') }}" required autocomplete="aadhar">
                    ...
                    <div class="form-group row">
                       ...
                       <div class="col-md-6">
                                <input id="cover_image" type="file" class="form-control " name="cover_image" value="Addcover" required >
                        </div>
                    </div> 
